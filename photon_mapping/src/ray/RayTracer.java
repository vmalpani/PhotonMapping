...
import ray.renderer.PhotonRenderer;
...
public class RayTracer {
    ...
    public static void renderImage(Scene scene) {
        ...
        if(renderer instanceof PhotonRenderer )
        {
        	
        	PhotonMap photonMap = new PhotonMap();
        	photonMap.buildPhotonMap(scene);
        	photonMap.buildCausticPhotonMap(scene);

        	
        	((PhotonRenderer) renderer).photonMap = photonMap;
        }
