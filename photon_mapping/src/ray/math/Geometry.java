...
public class Geometry {
	...
	public static void squareToCosineWeightedHemisphere(Point2 seed, Vector3 outPt) {
		Point2 discPoint = new Point2();
		squareToPolarDisc(seed, discPoint);
		outPt.set(discPoint.x * Math.cos(discPoint.y),
					discPoint.x * Math.sin(discPoint.y),
						Math.sqrt(Math.max(0.0f, 1 - discPoint.x * discPoint.x)));
	}
