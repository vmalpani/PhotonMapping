...
public class MeshTriangle extends Surface {
	...
	public AxisAlignedBoundingBox getBoundingBox() {
		AxisAlignedBoundingBox inBox = new AxisAlignedBoundingBox();
		inBox.add(new Point3(mesh.verts[3*v0], mesh.verts[3*v0 + 1], mesh.verts[3*v0 + 2]));
		inBox.add(new Point3(mesh.verts[3*v1], mesh.verts[3*v1 + 1], mesh.verts[3*v1 + 2]));
		inBox.add(new Point3(mesh.verts[3*v2], mesh.verts[3*v2 + 1], mesh.verts[3*v2 + 2]));
        return inBox;
	}  
}
