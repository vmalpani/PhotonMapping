 ...
 * PhotonAxisAlignedBoundingBox.java
 *  Copyright 2005 Program of Computer Graphics, Cornell University
 */
public class PhotonAxisAlignedBoundingBox {
   ...
   */
  public PhotonAxisAlignedBoundingBox() {
   ...
   * @param box1
   */
  public void add(PhotonAxisAlignedBoundingBox inBox) {
   ...
   * @param box
   */
  public void set(PhotonAxisAlignedBoundingBox box) {
   ...
   * @return
   */
  public boolean intersects(PhotonAxisAlignedBoundingBox box) {
